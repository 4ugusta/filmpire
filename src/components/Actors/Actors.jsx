...
import { Button, Box, CircularProgress, Grid, Typography, styled } from '@mui/material';
  ...
  return (
    <>
      <Grid container spacing={3}>
        <Grid item lg={5} xl={4}>
          <ActorImg src={`https://image.tmdb.org/t/p/w780/${data?.profile_path}`} alt={data.name} />
        </Grid>
